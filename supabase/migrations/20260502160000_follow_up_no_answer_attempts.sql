-- Add fu_no_answer_count to order_follow_ups to track follow-up agent's no_answer attempts
-- separately from the confirmation agent's attempt_count on orders.
