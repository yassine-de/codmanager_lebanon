...
BEGIN
  ...
  -- Dropped count: all orders created in the period (time-based, entry fee)
  ...
  -- Confirmed count for call center: orders linked to THIS invoice with confirmed status
  -- This correctly handles orders created in previous periods but confirmed in this one
  SELECT COUNT(*)::integer
